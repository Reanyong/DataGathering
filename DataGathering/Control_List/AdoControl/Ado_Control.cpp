	...
	try
	{
		...
		if(strDBType != "POSTGRE")
		{
...
#ifdef _DEBUG
				TRACE("Ado-Contreol(%s) - DB 접속성공. Call Class Name : %s \n",m_strMsgName,strRunlog_E2);
#endif
			...
			else
			{
				...
				::SendMessage(m_MsgHwnd,m_Message,(long)strRunlog_E2.GetBuffer(strRunlog_E2.GetLength()),DB_ERROR);
#ifdef _DEBUG
				TRACE("Ado-Contreol(%s) - DB 접속실패. Call Class Name : %s \n",m_strMsgName,strRunlog_E2);
#endif
		...
		else
		{
			...
			if(nResultADO_DB == 1 )
			{
				...
				::SendMessage(m_MsgHwnd,m_Message,(long)strRunlog_E2.GetBuffer(strRunlog_E2.GetLength()),DB_SUCCESS);
#ifdef _DEBUG
				TRACE("ODBC-Contreol(%s) - DB 접속성공. Call Class Name : %s \n",m_strMsgName,strRunlog_E2);
#endif
				//WriteLog(strRunlog_E2);
				_WriteLog(m_strLogPath,strRunlog_E2,m_nLogFlag);
			...
			else
			{
				...
				::SendMessage(m_MsgHwnd,m_Message,(long)strRunlog_E2.GetBuffer(strRunlog_E2.GetLength()),DB_ERROR);
#ifdef _DEBUG
				TRACE("ODBC-Contreol(%s) - DB 접속실패. Call Class Name : %s \n",m_strMsgName,strRunlog_E2);
#endif
			...
			*/
			...
			if(pADO_Connect)
			{
				if(pADO_Connect->State == adStateOpen)
				{
					pADO_Connect->Close();
#ifdef _DEBUG
					TRACE("Ado-Contreol(%s) - ADO 접속 해제 및 소멸 \n",m_strMsgName);
#endif
				}
	...
	try
	{
		...
		if(strDBType != "POSTGRE")
		{
			...
			if(pADO_Connect->State == adStateOpen)
			{
				...
				//WriteLog(strRunlog_E2);
#ifdef _DEBUG
				TRACE("Ado-Contreol-Sub(%s) - DB 접속성공. Call Class Name : %s \n",m_strMsgName,strRunlog_E2);
#endif
				return TRUE;
			}
			else
			{
				...
				::SendMessage(m_MsgHwnd,m_Message,(long)strRunlog_E2.GetBuffer(strRunlog_E2.GetLength()),DB_ERROR);
#ifdef _DEBUG
				TRACE("Ado-Contreol-Sub(%s) - DB 접속실패. Call Class Name : %s \n",m_strMsgName,strRunlog_E2);
#endif
				return FALSE;
			}
		}
		else
		{
			try
			{
				if(nResultADO_DB == 1 )
				{
					...
					//WriteLog(strRunlog_E2);
#ifdef _DEBUG
					TRACE("ODBC-Contreol-Sub(%s) - DB 접속성공. Call Class Name : %s \n",m_strMsgName,strRunlog_E2);
#endif
				...
				else
				{
					...
					::SendMessage(m_MsgHwnd,m_Message,(long)strRunlog_E2.GetBuffer(strRunlog_E2.GetLength()),DB_ERROR);
#ifdef _DEBUG
					TRACE("ODBC-Contreol-Sub(%s) - DB 접속실패. Call Class Name : %s \n",m_strMsgName,strRunlog_E2);
#endif
					return FALSE;
		...
		try
		{
			if(pADO_Connect)
			{
				if(pADO_Connect->State == adStateOpen)
				{
					pADO_Connect->Close();
#ifdef _DEBUG
					TRACE("Ado-Contreol_Sub(%s) - ADO 접속 해제 및 소멸 \n",m_strMsgName);
#endif
				}
